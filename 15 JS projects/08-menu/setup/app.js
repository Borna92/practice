...
function displayFilterButtons(menu) {
  ...
  let displayFilters = unique.map((item) => {
    return `<button class="filter-btn" type="button" id="${item}">${item}</button>`;
  });

  buttonContainer.innerHTML = displayFilters.join("");
